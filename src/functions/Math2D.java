...
public class Math2D {	
	...
	public static double calcLenX(double dis, double dir) {
	...
	public static double calcLenY(double dis, double dir) {
	...
	public static double calcPtDis(double x1, double y1, double x2, double y2) {
